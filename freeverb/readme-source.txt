...
Finally, note that there is also a built copy of this version of Freeverb called "Freeverb.component" - this is an Audio Unit plugin for Mac OS X (v10.2 or higher).
