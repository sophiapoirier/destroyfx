...
cl  /FD  /MD /nologo /O2 /Ot /Og /Oi /Oy /Gs /GD /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /I..\windowingstub\ /I..\vstsdk\ /I..\dfx-library\ /LD /D "TARGET_API_VST" /FI "..\windowingstub\windowingstubdefs.h" /D "VST_NUM_CHANNELS=2" ..\windowingstub\windowingstub.cpp ..\vstsdk\audioeffect.cpp ..\vstsdk\audioeffectx.cpp ..\dfx-library\dfxplugin.cpp ..\dfx-library\dfxparameter.cpp ..\dfx-library\dfxsettings.cpp ..\dfx-library\dfxmidi.cpp ..\dfx-library\dfxplugin-vst.cpp /c
